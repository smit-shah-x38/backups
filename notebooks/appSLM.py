...
def fashion_filter(query):
    ...
    keywords = ["clothes", "shoes", "shopping", "style", "fashion", "dress", "outfit", "accessories", "jewelry",
                "bag", "hat", "scarf", "coat", "jeans", "t-shirt", "skirt", "sweater", "boots", "sneakers", "sandals", "heels"]
...
def generate_response(user_prompt):
    ...
    # Sampling args
    # @param {type:"slider", min:32.0, max:3072.0, step:32}
    max_new_tokens = 128
    ...
    keywords = ["fashion", "style", "purchase", "shopping", "clothing", "apparel", "accessories", "shoes", "bags", "jewelry",
                "outfit", "trend", "designer", "brand", "shop", "store", "online", "buy", "sell", "order", "delivery", "return"]
...
#     matches_sorted = match3.sort_values(by=['Lookup 1 Confidence'], ascending=False)
...
def getsimilar(keylist):
    ...
    matches4_sorted = match4.sort_values(
        by=['Lookup 1 Confidence'], ascending=False)
...
@app.route('/UNlwkXxjIOVuOJJHOgLV/bot/response', methods=['POST'])
def respondSecure():
    if request.method == 'POST':
        json_ = request.get_json()
        user_prompt = json_["prompt"]

        gen_r = generate_response(user_prompt)
#         gen_chunks = getchunks(gen_r)
#         gen_i = getitems(gen_chunks)
